...
public class MasterRenderer {
    ...
    public void render(GameState gameState, Camera camera, float interpolation) {
        ...
        renderEnhancedTerrain(camera, sunDirection, sunColor, ambientColor);
        ...
        renderAnimatedObjects(gameState, sunColor, ambientColor);
    ...
    private void renderCloud(Vector3f position, float time, Camera camera) {
        ...
        // Billboard the cloud to face the camera
        Vector3f cameraPos = camera.getPosition();
        Vector3f direction = new Vector3f(cameraPos).sub(position).normalize();
    ...
    private void renderUI(Camera camera, GameState gameState) {
        ...
        // Render camera position text (simplified)
        Vector3f pos = camera.getPosition();
        // Note: Text rendering would require additional font rendering system
